...
user_pref("browser.search.geoSpecificDefaults.url", ""); */
  ...
  /* 0850a: */
    ...
    user_pref("browser.urlbar.suggest.bookmark", false);
    user_pref("browser.urlbar.suggest.openpage", false);
    user_pref("browser.urlbar.suggest.topsites", false); //disable location bar suggestion types
...
/*** BREAKAGE AND SECURITY TWEAKS ***/
  ...
  /* 2402  */ user_pref("dom.event.clipboardevents.enabled", false); // Disable that websites can get notifications if you copy, paste, or cut something from a web page, and it lets them know which part of the page had been selected
  user_pref("network.security.esni.enabled", true); //Your browser encrypted the SNI 
